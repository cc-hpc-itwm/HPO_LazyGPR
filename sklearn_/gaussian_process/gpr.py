...
class GaussianProcessRegressor(BaseEstimator, RegressorMixin,
    ...
    def fit(self, X, y):
        ...
        try:
            ...
            # self.L changed, self._K_inv needs to be recomputed
            self._K_inv = None
            ...
            raise
        self.alpha_ = cho_solve((self.L, True), self.y_train_)  # Line 3
    ...
    def predict(self, X, return_std=False, return_cov=False):
        ...
        if not hasattr(self, "X_train_"):  # Unfitted;predict based on GP prior
            ...
            if return_cov:
                v = cho_solve((self.L, True), K_trans.T)  # Line 5
